...
import { paused, pausedKeypoints } from "$legacy-pages-lib/paused";
import keypoints from "$legacy-pages-lib/pose-detection/keypoints";
import { selectedExercise } from "$legacy-pages-lib/exercises/store";
import {
  scale,
  scaleKeypoints,
} from "$legacy-pages-lib/pose-detection/scaleKeypoints";
