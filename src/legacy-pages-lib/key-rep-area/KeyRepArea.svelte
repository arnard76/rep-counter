<script lang="ts">
  import Keypoint from "$legacy-pages-lib/pose-detection/Keypoint.svelte";
  import Line from "$legacy-pages-lib/pose-detection/StraightLine.svelte";
  import selectedKeyRepArea from "$legacy-pages-lib/key-rep-area/selected";
