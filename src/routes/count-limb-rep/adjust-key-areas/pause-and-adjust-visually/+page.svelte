<script>
  ...
  import { controlledKeypoints } from "$legacy-pages-lib/pose-detection/otherKeypointStores";
  ...
  import LimbRepCounter from "$legacy-pages-lib/count-reps/LimbRepCounter.svelte";
